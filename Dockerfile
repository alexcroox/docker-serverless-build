...
RUN apt-get --yes --force-yes -y update \
    && apt-get install --yes --force-yes -y curl gnupg bzip2 \
    ...
    && apt-get install --yes --force-yes -y python3 xvfb libgtk-3-dev libnotify-dev libgconf-2-4 libnss3 libxss1 libasound2 \
